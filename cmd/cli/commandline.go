...
func Commandline(client *ads.Client) {
	...
	completer := readline.NewPrefixCompleter(
		...
		readline.PcItem("read_attributes",
			readline.PcItem("Main.var_with_standard_attribute"),
			readline.PcItem("Main.var_with_custom_attribute"),
		),
		...
		readline.PcItem("subscribe",
			readline.PcItem("Global.int_counter"),
			readline.PcItem("Global.bool_toggle"),
			readline.PcItem("Global.timed_int_counter"),
			readline.PcItem("Global.timed_bool_toggle"),
			readline.PcItem("Global.int_var"),
			readline.PcItem("Global.bool_var"),
			readline.PcItem("Global.dint_var"),
			readline.PcItem("Global.int_counter_active"),
			readline.PcItem("Global.bool_toggle_active"),
			readline.PcItem("Global.timed_counter_active"),
			readline.PcItem("Global.timed_toggle_active"),
			readline.PcItem("Global.cycle_period"),
			readline.PcItem("Global.int_array"),
			readline.PcItem("Global.test_struct"),
		),
